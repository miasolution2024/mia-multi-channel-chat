...
import { useStatisticCommentData } from "./hooks/statistic-comments-data";
...
interface EcommerceCommentsChartProps {
  pages: OmniChoices[];
  startDate: string;
  endDate: string;
}

const EcommerceCommentsChart: React.FC<EcommerceCommentsChartProps> = ({
  pages,
  startDate,
  endDate,
}) => {
        ...
        >
          ...
          >
            {!pages || pages.length === 0
              ...
              : "Không có dữ liệu lượt chia sẻ trong khoảng thời gian đã chọn."}
          </Typography>
        </Box>
      </Card>
    );
...
export default EcommerceCommentsChart;
