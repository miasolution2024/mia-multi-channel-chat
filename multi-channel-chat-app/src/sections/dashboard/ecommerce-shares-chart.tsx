...
import { useStatisticShareData } from "./hooks/statistic-shares-data";
import { OmniChoices } from "./type";

interface EcommerceSharesChartProps {
  pages: OmniChoices[];
  startDate: string;
  endDate: string;
}

const EcommerceSharesChart: React.FC<EcommerceSharesChartProps> = ({
  pages,
  startDate,
  endDate,
}) => {
...
export default EcommerceSharesChart;
