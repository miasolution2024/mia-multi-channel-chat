...
type InventoryTransactionTableToolbarProps = {
  filters: {
...
export function InventoryTransactionTableToolbar({
  filters,
  onResetPage,
}: InventoryTransactionTableToolbarProps) {
  const popover = usePopover();

  const handleFilterName = useCallback(
    (event: any) => {
      onResetPage();
      filters.setState({ productName: event.target.value });
    },
    [filters, onResetPage]
  );
