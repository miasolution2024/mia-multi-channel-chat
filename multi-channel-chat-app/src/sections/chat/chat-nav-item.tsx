...
export function ChatNavItem({ selected, collapse, conversation, onCloseMobile }: any) {
  ...
  const renderGroup = (
    <Badge
      variant={hasOnlineInGroup ? 'dot' : 'standard'}
      anchorOrigin={{ vertical: 'bottom', horizontal: 'right' }}
    >
      <AvatarGroup variant="circular" sx={{ width: 48, height: 48 }}>
