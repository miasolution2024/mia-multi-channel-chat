...
const MuiDataGrid = {
  ...
  defaultProps: {
    slots: {
      ...
      columnMenuIcon: (props: any) => (
        <DataGridMoreIcon width={20} {...props} />
      ),
      columnMenuSortAscendingIcon: (props: any) => (
        <DataGridArrowUpIcon {...props} />
      ),
      columnMenuSortDescendingIcon: (props: any) => (
      ...
      columnMenuManageColumnsIcon: (props: any) => (
      ...
      /* Density */
      densityCompactIcon: (props: any) => (
        <DataGridDensityCompactIcon {...props} />
      ),
      densityStandardIcon: (props: any) => (
